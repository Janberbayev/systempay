        ...
        <div class="row">
            <div class="col-lg-10 mx-auto">
                ...
                <div class="text-center mb-5">
                    ...
                    <p class="lead fw-bold">Измените информацию о роли и права доступа</p>
                </div>
                ...
                <div class="card-creative p-4 mb-4" style="background: linear-gradient(135deg, rgba(37, 99, 235, 0.05), rgba(59, 130, 246, 0.05)); border: 1px solid var(--border-color);">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="fw-black mb-1">{{ $role->name }}</h3>
                            <p class="text-muted mb-0">
                                <i class="bi bi-calendar me-2"></i>
                                Создана: {{ $role->created_at->format('d.m.Y') }}
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="mb-4">
                                            ...
                                            <li class="mb-3 pb-3 {{ !$loop->last ? 'border-bottom' : '' }}" style="border-bottom-color: #e0e0e0 !important;">
                                                <div class="form-check d-flex align-items-center">
                                                    ...
                                                    <label
                                                        ...
                                                        style="cursor: pointer; font-size: 1rem; {{ $role->hasPermissionTo($permission->name) ? 'color: var(--primary);' : '' }}"
                                                    >
                                                        <i class="bi bi-check-square me-2" style="color: var(--primary);"></i>
                                                        {{$permission->name}}
                                                    </label>
                                                    @if($role->hasPermissionTo($permission->name))
                                                        <span class="badge-creative ms-2" style="background: var(--primary); color: white; border-color: var(--primary); padding: 4px 10px; border-radius: 8px; font-weight: 600; font-size: 0.75rem;">
                            ...
                            @else
                                <div class="alert alert-info" style="border-radius: 12px; border: 1px solid #06b6d4;">
                                    ...
                                    Нет доступных прав доступа. Создайте права доступа перед редактированием роли.
                                </div>
                            @endif
                        </div>
